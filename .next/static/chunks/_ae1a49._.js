(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_ae1a49._.js", {
...
"[project]/app/(routes)/cart/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Page() {
    _s();
    const { items, removeAll, removeItem, updateQuantity } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const totalPrice = items.reduce((total, product)=>{
        ...
        if (priceArray.length > 0) {
            ...
            const finalPrice = discountPercentage > 0 ? basePrice - basePrice * (discountPercentage / 100) : basePrice;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen max-w-6xl px-4 py-16 mx-auto sm:px-6 lg:px-8",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                fileName: "[project]/app/(routes)/cart/page.tsx",
                lineNumber: 32,
                columnNumber: 7
            }, this),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                className: "space-y-6",
                                children: items.map((product, index)=>{
                                    if (!product) {
                                    ...
                                    const priceArray = Array.isArray(product.prices) ? product.prices : [];
                                    const basePrice = priceArray.length > 0 ? parseFloat(priceArray[0]?.precio || "0") : 0;
                                    const discountPercentage = product.discountPercentage || 0;
                                    const quantity = product.quantity || 1;
                                    // Precio unitario, aplicando descuento si existe
                                    const unitPrice = discountPercentage > 0 ? (basePrice - basePrice * (discountPercentage / 100)).toFixed(2) : basePrice.toFixed(2);
                                    const imageUrl = product.image ? product.image : product.images?.[0]?.url ? `${"TURBOPACK compile-time value", "https://servidor-tricolor-64a23aa2b643.herokuapp.com"}${product.images[0].url}` : "https://via.placeholder.com/150";
                                    // Presentación elegida
                                    const presentation = priceArray.length > 0 ? priceArray[0]?.presentacion : "default";
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                onClick: ()=>updateQuantity(product.id, Math.max(quantity - 1, 1)),
...
_s(Page, "5yYoi+D6J3rQclVirqkQZYX6fnc=", false, function() {
    return [
...
"[project]/app/(routes)/cart/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_ae1a49._.js.map