...
"[project]/app/data/services/get-token.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/data/services/get-user-me-loader.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// @ts-nocheck
__turbopack_esm__({
    "getUserMeLoader": (()=>getUserMeLoader)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$services$2f$get$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/data/services/get-token.ts [app-route] (ecmascript)");
...
async function getUserMeLoader() {
    try {
        const baseUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStrapiURL"])();
        // Construimos la URL completa
        const url = new URL("/api/users/me", baseUrl);
        // Obtenemos el token de autenticación
        const authToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$services$2f$get$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthToken"])();
        if (!authToken) {
        ...
        if (!response.ok) {
            console.error(`getUserMeLoader: Error en la solicitud (${response.status})`, data);
            return {
                ok: false,
                data: null,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$services$2f$get$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/data/services/get-token.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$services$2f$get$2d$user$2d$me$2d$loader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/data/services/get-user-me-loader.ts [app-route] (ecmascript)");
;
;
;
async function GET() {
    // Obtén el token de autenticación
    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$services$2f$get$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuthToken"])();
    ...
    const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$services$2f$get$2d$user$2d$me$2d$loader$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserMeLoader"])();
    if (userData.ok) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            data: userData.data
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4599f5._.js.map